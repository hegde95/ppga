...
core_args = dict(emitter="""
    emitter (ribs2.emitters.EmitterBase): Emitter to use for generating
        solutions and updating the archive.
    """,
                 archive="""
    archive (ribs2.archives.ArchiveBase): Archive to use when creating
    ...
    value_batch  (numpy.ndarray): 1D array of floats returned by a series of
        ...
        refer to :meth:`ribs2.archives.add()`.
    """,
                 seed="""
