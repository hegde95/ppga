...
def parse_args():
    ...
    parser.add_argument('--datapath',
                        type=str,
                        help='Path to the archive snapshots')
...
def animated_surface(cfg):
    ...
    z_data = df.drop('Iteration',
                     axis=1).to_numpy().reshape(-1, 30,
                                                30)  # TODO: make this general
    ...
    fig = go.Figure(data=[go.Surface(z=z_data[0])],
