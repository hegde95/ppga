...
from ppga.models.actor_critic import Actor, PGAMEActor
from ppga.models.vectorized import VectorizedActor
from ppga.qd.visualize import grid_archive_heatmap
...
def evaluate(vec_agent,
    ...
    while not torch.all(dones):
        with torch.no_grad():
            ...
            obs, rew, next_dones, infos = vec_env.step(acts) # will probably require edits
...
def reevaluate_ppga_archive(env_cfg,
    ...
    vec_env = make_vec_env_isaac(env_cfg)
